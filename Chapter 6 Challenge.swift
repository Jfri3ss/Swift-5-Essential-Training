...
// 4
    var secrect: BonusEffect?
    
    
// 2 (Default Initializer, dont forget same as above plus self.name = name format)
...
//potion.secrect = partyWideEffect


// 8
var inventory = Inventory(items: [potion, antidote])
if let itemPower = inventory.storedItems[0].secrect?.bonus {
